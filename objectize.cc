...
EMSCRIPTEN_KEEPALIVE void doSmoothedPotentials(int *chunkCoords, unsigned int numChunkCoords, float *colorTargetCoordBuf, int width, int height, int depth, int colorTargetSize, float voxelSize, float *potentialsBuffer) {
  smoothedPotentials(chunkCoords, numChunkCoords, colorTargetCoordBuf, width, height, depth, colorTargetSize, voxelSize, potentialsBuffer);
}
