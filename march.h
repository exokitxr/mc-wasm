...
void marchPotentials(int dims[3], float shift[3], float size[3], float *potential, float *positions, unsigned int *faces, unsigned int &positionIndex, unsigned int &faceIndex);
